...
public class Permissions {
    ...
    public static final int STORAGE_PERMISSION_REQUEST_CODE = 102; // Nouveau code de demande pour la permission de stockage
    ...
    // Ajout de méthodes pour vérifier et demander la permission de stockage (lecture externe)
